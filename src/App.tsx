      ...
      {shouldPlayIntro ? (
        ...
        >
          ...
          <SuccessiveType
            onEnd={onIntroEnd}
            words={
              "We're UVS, your premier destination for comprehensive e-commerce services. Specializing in account boosting and offering a universal selection of accounts for various online games, we're your one-stop shop for all your gaming needs."
            }
            speed={1}
